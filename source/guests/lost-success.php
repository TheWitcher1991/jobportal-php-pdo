...
if (isset($_SESSION["$code-recovery"])) {
    ...
    <main id="wrapper">
        ...
        <div class="container">
            ...
            <div style="margin: 40px auto 100px auto" class="alert-block">Если Вы верно указали email, то на него придёт письмо для сброса пароля. Пожалуйста, следуйте инструкциям в письме. <br />
