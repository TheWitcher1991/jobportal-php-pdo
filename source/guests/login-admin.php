...
if (!isset($_SESSION['id']) && !isset($_SESSION['password'])) {
    ...
    if (isset($_POST['login2'])) {
        ...
        if (empty($_POST['admin2']) or trim($_POST['admin2']) == '') $err['admin2'] = 'Введите e-mail';
        if (strlen ($_POST['password2']) < 8) $err['password2'] = 'Пароль должен быть не меньше 8 символов';

        if (empty($err)) {
            $app->loginAdmin($_POST['admin2'], $_POST['password2'], $_POST['log-2']);
        }
    }
    ...
    <main id="wrapper">
        <div class="container">
            <div class="section-nav">
                ...
                <span>Вход в личный кабинет администратора</span>
            </div>
        </div>
            ...
            <div class="auth-alert">
                ...
                if (isset($_GET['error'])) {
                    ...
                    <div class="alert-block" style="margin: 0">
                        <div>
                            <span>Введённые Вами логин или пароль неверны</span>
                        </div>
            ...
            <div class="auth-content">
                ...
                <form method="post">
                    <div class="label-block">
                        ...
                        <input type="text" id="admin" name="admin2" required value="<?php echo $_POST['admin2']; ?>">
                        <? if (isset($err['admin'])) { ?> <span class="error"><? echo $err['admin']; ?></span> <? } ?>
                    </div>
