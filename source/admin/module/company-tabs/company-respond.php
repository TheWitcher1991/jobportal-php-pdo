        ...
        <div class="bsc-1">
            ...
            <div class="block-wrapper-manag">
                ...
                <div class="block-status">
                    ...
                    <a class="r-new <?php if (empty($_GET['f'])) { echo 'bs-active'; } ?>" href="/admin/info-companys?id=<?php echo $rc['id']; ?>&t=4">
                        <i class="mdi mdi-alert-decagram-outline"></i>
                        Неразобранные (<?php echo $app->count("SELECT * FROM `respond` WHERE `status` = 0 AND `company_id` = '$rc[id]'"); ?>)</a>

                    <a class="r-talk <?php if ($_GET['f'] == 2) { echo 'bs-active'; } ?>" href="/admin/info-companys?id=<?php echo $rc['id']; ?>&t=4&f=2">
                        <i class="mdi mdi-phone-in-talk-outline"></i>
                        Разговор по телефону (<?php echo $app->count("SELECT * FROM `respond` WHERE `status` = 2 AND `company_id` = '$rc[id]'"); ?>)</a>

                    <a class="r-meeting <?php if ($_GET['f'] == 3) { echo 'bs-active'; } ?>" href="/admin/info-companys?id=<?php echo $rc['id']; ?>&t=4&f=3">
                        <i class="mdi mdi-head-question-outline"></i>
                        Собеседование (<?php echo $app->count("SELECT * FROM `respond` WHERE `status` = 3 AND `company_id` = '$rc[id]'"); ?>)</a>

                    <a class="r-accept <?php if ($_GET['f'] == 4) { echo 'bs-active'; } ?>" href="/admin/info-companys?id=<?php echo $rc['id']; ?>&t=4&f=4">
                        <i class="mdi mdi-hand-wave-outline"></i>
                        Принят на работу (<?php echo $app->count("SELECT * FROM `respond` WHERE `status` = 4 AND `company_id` = '$rc[id]'"); ?>)</a>

                    <a class="r-none <?php if ($_GET['f'] == 5) { echo 'bs-active'; } ?>" href="/admin/info-companys?id=<?php echo $rc['id']; ?>&t=4&f=5">
                        <i class="mdi mdi-delete-variant"></i>
                        Отказ (<?php echo $app->count("SELECT * FROM `respond` WHERE `status` = 5 AND `company_id` = '$rc[id]'"); ?>)</a>

                    <a class="r-none <?php if ($_GET['f'] == 6) { echo 'bs-active'; } ?>" href="/admin/info-companys?id=<?php echo $rc['id']; ?>&t=4&f=6">
                        <i class="mdi mdi-account-plus-outline"></i>
                        Приглашённые (<?php echo $app->count("SELECT * FROM `respond` WHERE `status` = 6 AND `company_id` = '$rc[id]'"); ?>)</a>
