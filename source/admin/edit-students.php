...
if (isset($_SESSION['id']) && $_SESSION['type'] == 'admin') {
    ...
    Head($user['name'] . ' ' . $user['surname'] . ' - редактировать');
    ?>
                    ...
                    <div class="al-stats" style="margin: 0 0 30px 0;">
                        <ul>
                            ...
                            <li>
                                <div class="as-t">
                                    <?php
                                    $views_r = $app->count("SELECT * FROM `online_resume` WHERE `users` = $user[id]");
                                    ?>
                            ...
                            <li>
                                <div class="as-t">
                                    <span class="as-tt"><?php echo $user['view'] ?></span>
                            ...
                            <li>
                                <div class="as-t">
                                    <span class="as-tt"><?php echo $app->rowCount("SELECT * FROM `respond` WHERE `user_id` = :id", [':id' => $user['id']]); ?></span>
                    ...
                    <div style="margin-bottom: 30px" class="pr-data-block block-p bl-1">
                        ...
                        <form role="form" class="form-profile" method="POST">
                            ...
                            <div class="block-status">
                                ...
                                <a target="_blank" href="/admin/info-students?id=<? echo $user['id']; ?>">
                                    <i class="mdi mdi-finance"></i>
                                    Анализ </a>

                                <a target="_blank" href="/resume?id=<? echo $user['id']; ?>">
